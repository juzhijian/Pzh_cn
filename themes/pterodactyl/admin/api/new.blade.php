...
@section('content-header')
    <h1>面板API<small>创建一个新的面板API凭据</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">后台</a></li>
        <li><a href="{{ route('admin.api.index') }}">面板API</a></li>
        <li class="active">创建凭据</li>
    </ol>
@endsection
            ...
            <div class="col-sm-4 col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <p class="text-muted">一旦您创建了一个API凭据，您将无法对这个凭据进行修改，您只能创建一个新的凭据。</p>
                    </div>
